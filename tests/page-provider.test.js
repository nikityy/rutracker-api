...
describe("#login", () => {
  test("making correct request", () => {
    ...
    const pageProvider = new PageProvider("http://rutracker-url", proxy);
    ...
    expect(request.mock.calls[0][0]).toEqual({
      ...
      maxRedirects: 0,
      method: "POST",
      url: "http://rutracker-url/forum/login.php",
      proxy: {
        host: "proxy-host",
        port: 1234
      },
  ...
  test("correctly parses cookie", () => {
    ...
    const pageProvider = new PageProvider("http://rutracker-url");
...
describe("#search", () => {
  test("making correct request", () => {
    ...
    expect(request).toHaveBeenCalledWith({
      ...
      url: `http://rutracker-url/forum/tracker.php?nm=${query}`,
      proxy: undefined
    });
...
describe("#thread", () => {
  test("making correct request", () => {
    ...
    expect(request).toHaveBeenCalledWith({
      ...
      method: "GET",
      responseType: "arraybuffer",
      url: `http://rutracker-url/forum/viewtopic.php?t=${id}`
    });
  });
...
describe("#torrentFile", () => {
  test("making correct request", () => {
    ...
    expect(request).toHaveBeenCalledWith({
      ...
      method: "GET",
      responseType: "stream",
      url: `http://rutracker-url/forum/dl.php?t=${id}`
    });
  });
